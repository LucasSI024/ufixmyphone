...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Fixbod — Laat je telefoon repareren tegen jouw prijs" },
      { name: "description", content: "Plaats je kapotte telefoon op Fixbod en ontvang biedingen van reparateurs door heel Nederland. Kies zelf het beste bod." },
      { name: "author", content: "Fixbod" },
      { property: "og:title", content: "Fixbod — Reparatiebiedingen voor je telefoon" },
