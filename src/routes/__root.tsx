...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "I Will Make It — Reparatiebiedingen voor je telefoon" },
      { property: "og:description", content: "Marktplaats voor telefoonreparaties. Reparateurs bieden, jij kiest." },
