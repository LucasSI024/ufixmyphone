...
export const Route = createFileRoute("/feed")({
  head: () => ({ meta: [{ title: "Open reparaties — UFixMyPhone" }] }),
  component: FeedPage,
});
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1 flex flex-wrap gap-1.5">
                        ...
                        {getBudgetSignal(req.category, req.budget_max)?.tone === "low" && (
                      ...
                      <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
                        ...
                        <span className="flex items-center gap-1"><Euro className="h-3.5 w-3.5" /> {getMarketEstimate(req.category).label.replace("zitten vaak rond", "vaak")}</span>
                        {req.budget_max != null && (
